...
const pages = [
  {
    ...
    music: "/audio/S_1WhatsApp Audio 2025-04-25 at 01.18.37_3e79ce51.dat.unknown",
  ...
  },
  {
    id: 2,
    bgImage: "url('/imgs/sat_1.jpg')",
    music: "/audio/S_2WhatsApp Audio 2025-04-25 at 01.23.21_97a8dcdc.dat.unknown",
    content:
  ...
  },
  {
    ...
    music: "/audio/S_3WhatsApp Audio 2025-04-25 at 01.25.45_56a9cf63.dat.unknown",
    content:
  ...
  },
  {
    ...
    music: "/audio/S_4WhatsApp Audio 2025-04-25 at 01.30.43_f0705d25.dat.unknown",
    content:
  ...
  },
  {
    ...
    music: "/audio/S_5WhatsApp Audio 2025-04-25 at 01.34.18_67a59c42.dat.unknown",
    content:
  ...
  },
  {
    ...
    music: "/audio/S_6WhatsApp Audio 2025-04-25 at 01.34.18_67a59c42.dat.unknown",
      ...
      <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 z-10 flex space-x-2">
        {pages.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full ${index === pageIndex ? 'bg-white' : 'bg-gray-400'}`}
