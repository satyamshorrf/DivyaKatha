...
const pages = [
  {
    ...
    बहुत समय पहले, जब संसार में केवल सत्य, धर्म, शांति और तपस्या का राज्य था, वह युग था — सतयुग। लोग लंबे जीवन जीते थे, झूठ और पाप का कोई अस्तित्व नहीं था। लेकिन जब भी पृथ्वी पर कोई संकट ।`,
  },
  {
    id: 2,
    ...
    content:
      " अधर्म बढ़ता या कोई राक्षस उत्पात मचाता, भगवान विष्णु किसी न किसी रूप में अवतरित होकर संसार की रक्षा करते सबसे पहले, एक बार जब प्रलय आया और सब कुछ जल में समा गया, तो भगवान मत्स्य अवतार (मछली रूप) में आए। उन्होंने नाव में।",
  },
  {
    id: 3,
    ...
    content:
      "  बैठे ऋषि मनु को बचाया और वेदों की रक्षा की, ताकि ज्ञान और धर्म फिर से स्थापित हो सकें फिर आया समय समुद्र मंथन का। देवता और असुर मंथन करने लगे, लेकिन मंदराचल पर्वत डूबने लगा। तब भगवान ने कूर्म अवतार (कछुए का रूप) लिया ।",
  },
  {
    id: 4,
    ...
    content:
      " और अपनी पीठ पर पर्वत को संभाला।  यह हमें सिखाता है — धैर्य और सेवा ही जीवन की नींव हैं इसके बाद, धरती पर संकट आया जब राक्षस हिरण्याक्ष ने पृथ्वी को पाताल में छुपा दिया। भगवान विष्णु ने वराह अवतार (सूअर रूप) लिया, युद्ध किया और पृथ्वी को बचाया।",
  },
  {
    id: 5,
    ...
    content:
      "  यह संदेश दिया कि प्रकृति की रक्षा हमारा धर्म है। लेकिन सबसे चमत्कारी अवतार था — नरसिंह अवतार। भक्त प्रह्लाद पर अत्याचारी हिरण्यकशिपु का आतंक था। उसने कहा, “तेरा भगवान कहाँ है?” तभी भगवान विष्णु खंभे से आधे मानव और आधे सिंह के रूप में प्रकट हुए — ",
  },
  {
    id: 6,
    ...
    content: ` न दिन था, न रात; न घर था, न बाहर — और राक्षस का अंत कर दिया।
    यह कहानी सिखाती है:
