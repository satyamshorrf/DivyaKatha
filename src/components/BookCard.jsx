...
//     type: 'cover',
//     content: (
//       <div className="page-cover flex flex-col items-center justify-center h-full text-center">
//         <h1 className="text-4xl font-bold text-white">Bhagavad Gita</h1>
//         <img src="/imgs/av_1.jpg" alt="Cover" className="w-40 h-40 mt-4 rounded-xl border-4 border-yellow-600" />
//       </div>
//     ),
//   },
//   {
...
//         <p className="text-sm text-gray-600 italic">Arjuna Vishada Yoga - Arjuna’s Dilemma</p>
...
//         <p className="text-sm">
//           Dhritarashtra said: O Sanjaya, what did my sons and the sons of Pandu do when they
//           assembled on the holy field of Kurukshetra, eager for battle?
//         </p>
//         <p className="mt-4 text-sm font-semibold text-gray-800">Explanation:</p>
//         <p className="text-sm">
//           The Bhagavad Gita begins with King Dhritarashtra asking his secretary Sanjaya about the
//           battle between his sons (the Kauravas) and their cousins (the Pandavas) on the sacred
...
//         <img src="/imgs/av_2.jpg" alt="Krishna and Arjuna" className="w-full h-full object-cover rounded-xl border-4 border-yellow-600" />
//       </div>
//     ),
//   },
//   {
...
//     content: (
//       <div className="page-content">
//         <h2 className="text-lg font-bold text-red-700">More Teachings</h2>
//         <p className="text-sm">
//           The Gita offers profound teachings on duty, righteousness, and spiritual wisdom.
//         </p>
//       </div>
//     ),
//   },
...
//     content: (
//       <div className="page-cover flex flex-col items-center justify-center h-full text-center">
//         <h1 className="text-2xl font-bold text-white">The End</h1>
//         <img src="/imgs/av_3.jpg" alt="Back Cover" className="w-32 h-32 mt-4 rounded-xl border-4 border-yellow-600" />
//       </div>
//     ),
//   },
// ];
...
//   useEffect(() => {
//     // Play the initial audio when the book is loaded.
//     if (audioRef.current) {
...
//   return (
//     <div className={`min-h-screen ${backgrounds[currentPage]} flex items-center justify-center p-6`}>
//       <HTMLFlipBook
//         width={400}
//         height={500}
//         size="fixed"
...
//       >
//         {pages.map((page, idx) => (
//           <div key={idx} className="page bg-white border-4 border-yellow-600 rounded-xl p-4 shadow-lg">
//             {page.content}
//           </div>
//         ))}
//       </HTMLFlipBook>
...
//       <button className='bg-blue-500 text-white font-bold py-2 px-4 rounded mt-4' onClick={() => book.current.pageFlip().flipNext()}>
//         Next Page
//       </button>
//       <button className='bg-blue-500 text-white font-bold py-2 px-4 rounded mt-4 ml-4' onClick={() => book.current.pageFlip().flipPrev()}>
//         Previous Page
//       </button>
    ...
    content: (
      <div className="page-cover flex flex-col items-center justify-center h-full text-center">
        ...
        <img
          src="/imgs/av_3.jpg"
          alt="Back Cover"
          className="w-32 h-32 mt-4 rounded-xl border-4 border-yellow-600"
        />
      </div>
    ),
  },
